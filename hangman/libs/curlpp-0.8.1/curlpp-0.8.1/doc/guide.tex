...
The \verb+string::c_str()+ function is passed to libcurl.

\subsubsection{The list template of string type}
...
\verb+list+. cURLpp this transform internally the \verb+list+
...
\begin{verbatim}
      typedef cURLpp::OptionTrait< string, 
...
\begin{verbatim}
      ...
      typedef cURLpp::OptionTrait< list< string >, 
